...
func (*ExtraMessage) Descriptor() ([]byte, []int) {
	return fileDescriptor_extension_extra_f94ee53159154a32, []int{0}
}
...
func init() {
	proto.RegisterFile("extension_extra/extension_extra.proto", fileDescriptor_extension_extra_f94ee53159154a32)
}

var fileDescriptor_extension_extra_f94ee53159154a32 = []byte{
