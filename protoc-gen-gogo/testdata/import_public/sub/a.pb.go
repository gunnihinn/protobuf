...
func (E) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_a_47fc651322268618, []int{0}
}
...
func init() { proto.RegisterFile("import_public/sub/a.proto", fileDescriptor_a_47fc651322268618) }

var fileDescriptor_a_47fc651322268618 = []byte{
