...
func (Request_Flavour) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_proto3_b752df9053681db5, []int{0, 0}
}
...
func (*Request) Descriptor() ([]byte, []int) {
	return fileDescriptor_proto3_b752df9053681db5, []int{0}
}
...
func (*Book) Descriptor() ([]byte, []int) {
	return fileDescriptor_proto3_b752df9053681db5, []int{1}
}
...
func init() { proto.RegisterFile("proto3/proto3.proto", fileDescriptor_proto3_b752df9053681db5) }

var fileDescriptor_proto3_b752df9053681db5 = []byte{
