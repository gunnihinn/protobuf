...
func (*Castaway) Descriptor() ([]byte, []int) {
	return fileDescriptor_casttype_370f5de424fd68cf, []int{0}
}
...
func (*Wilson) Descriptor() ([]byte, []int) {
	return fileDescriptor_casttype_370f5de424fd68cf, []int{1}
}
...
func init() {
	proto.RegisterFile("combos/marshaler/casttype.proto", fileDescriptor_casttype_370f5de424fd68cf)
}

var fileDescriptor_casttype_370f5de424fd68cf = []byte{
