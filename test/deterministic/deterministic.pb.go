...
func (*OrderedMap) Descriptor() ([]byte, []int) {
	return fileDescriptor_deterministic_c43cf4be86cb35ca, []int{0}
}
...
func (*UnorderedMap) Descriptor() ([]byte, []int) {
	return fileDescriptor_deterministic_c43cf4be86cb35ca, []int{1}
}
...
func (*MapNoMarshaler) Descriptor() ([]byte, []int) {
	return fileDescriptor_deterministic_c43cf4be86cb35ca, []int{2}
}
...
func (*NestedOrderedMap) Descriptor() ([]byte, []int) {
	return fileDescriptor_deterministic_c43cf4be86cb35ca, []int{3}
}
...
func (*NestedMap1) Descriptor() ([]byte, []int) {
	return fileDescriptor_deterministic_c43cf4be86cb35ca, []int{4}
}
...
func (*NestedUnorderedMap) Descriptor() ([]byte, []int) {
	return fileDescriptor_deterministic_c43cf4be86cb35ca, []int{5}
}
...
func (*NestedMap2) Descriptor() ([]byte, []int) {
	return fileDescriptor_deterministic_c43cf4be86cb35ca, []int{6}
}
...
func init() { proto.RegisterFile("deterministic.proto", fileDescriptor_deterministic_c43cf4be86cb35ca) }

var fileDescriptor_deterministic_c43cf4be86cb35ca = []byte{
