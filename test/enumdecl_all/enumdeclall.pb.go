...
func (MyEnum) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_enumdeclall_c55c6b0e7d842bd6, []int{0}
}
...
func (MyOtherEnum) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_enumdeclall_c55c6b0e7d842bd6, []int{1}
}
...
func init() { proto.RegisterFile("enumdeclall.proto", fileDescriptor_enumdeclall_c55c6b0e7d842bd6) }

var fileDescriptor_enumdeclall_c55c6b0e7d842bd6 = []byte{
