...
func (*MapAndSortKeys) Descriptor() ([]byte, []int) {
	return fileDescriptor_importduplicate_c22dbf8614925319, []int{0}
}
...
func init() {
	proto.RegisterFile("importduplicate.proto", fileDescriptor_importduplicate_c22dbf8614925319)
}

var fileDescriptor_importduplicate_c22dbf8614925319 = []byte{
