...
func (*Dropped) Descriptor() ([]byte, []int) {
	return fileDescriptor_issue260_b7f7729e7cfe1e88, []int{0}
}
...
func (*DroppedWithoutGetters) Descriptor() ([]byte, []int) {
	return fileDescriptor_issue260_b7f7729e7cfe1e88, []int{1}
}
...
func (*Kept) Descriptor() ([]byte, []int) {
	return fileDescriptor_issue260_b7f7729e7cfe1e88, []int{2}
}
...
var fileDescriptor_issue260_b7f7729e7cfe1e88 = []byte{
