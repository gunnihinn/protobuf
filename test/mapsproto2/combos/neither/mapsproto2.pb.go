...
func (MapEnum) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_mapsproto2_4eddb01499a7d231, []int{0}
}
...
func (*CustomMap) Descriptor() ([]byte, []int) {
	return fileDescriptor_mapsproto2_4eddb01499a7d231, []int{1}
}
...
func (*AllMaps) Descriptor() ([]byte, []int) {
	return fileDescriptor_mapsproto2_4eddb01499a7d231, []int{2}
}
...
func (*AllMapsOrdered) Descriptor() ([]byte, []int) {
	return fileDescriptor_mapsproto2_4eddb01499a7d231, []int{3}
}
...
func init() {
	proto.RegisterFile("combos/neither/mapsproto2.proto", fileDescriptor_mapsproto2_4eddb01499a7d231)
}

var fileDescriptor_mapsproto2_4eddb01499a7d231 = []byte{
