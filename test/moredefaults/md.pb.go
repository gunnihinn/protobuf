...
func (*MoreDefaultsB) Descriptor() ([]byte, []int) {
	return fileDescriptor_md_ffa15d03b46b2f67, []int{0}
}
...
func (*MoreDefaultsA) Descriptor() ([]byte, []int) {
	return fileDescriptor_md_ffa15d03b46b2f67, []int{1}
}
...
func init() { proto.RegisterFile("md.proto", fileDescriptor_md_ffa15d03b46b2f67) }

var fileDescriptor_md_ffa15d03b46b2f67 = []byte{
