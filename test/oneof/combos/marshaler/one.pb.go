...
func (*Subby) Descriptor() ([]byte, []int) {
	return fileDescriptor_one_c481f4ef9fbd9591, []int{0}
}
...
func (*AllTypesOneOf) Descriptor() ([]byte, []int) {
	return fileDescriptor_one_c481f4ef9fbd9591, []int{1}
}
...
func (*TwoOneofs) Descriptor() ([]byte, []int) {
	return fileDescriptor_one_c481f4ef9fbd9591, []int{2}
}
...
func (*CustomOneof) Descriptor() ([]byte, []int) {
	return fileDescriptor_one_c481f4ef9fbd9591, []int{3}
}
...
func init() { proto.RegisterFile("combos/marshaler/one.proto", fileDescriptor_one_c481f4ef9fbd9591) }

var fileDescriptor_one_c481f4ef9fbd9591 = []byte{
