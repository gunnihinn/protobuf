...
func (*Subby) Descriptor() ([]byte, []int) {
	return fileDescriptor_one_50ec41fa8cfcd59a, []int{0}
}
...
func (*AllTypesOneOf) Descriptor() ([]byte, []int) {
	return fileDescriptor_one_50ec41fa8cfcd59a, []int{1}
}
...
func (*TwoOneofs) Descriptor() ([]byte, []int) {
	return fileDescriptor_one_50ec41fa8cfcd59a, []int{2}
}
...
func (*CustomOneof) Descriptor() ([]byte, []int) {
	return fileDescriptor_one_50ec41fa8cfcd59a, []int{3}
}
...
func init() { proto.RegisterFile("combos/neither/one.proto", fileDescriptor_one_50ec41fa8cfcd59a) }

var fileDescriptor_one_50ec41fa8cfcd59a = []byte{
