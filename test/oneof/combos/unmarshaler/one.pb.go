...
func (*Subby) Descriptor() ([]byte, []int) {
	return fileDescriptor_one_0d3990743d3d95b6, []int{0}
}
...
func (*AllTypesOneOf) Descriptor() ([]byte, []int) {
	return fileDescriptor_one_0d3990743d3d95b6, []int{1}
}
...
func (*TwoOneofs) Descriptor() ([]byte, []int) {
	return fileDescriptor_one_0d3990743d3d95b6, []int{2}
}
...
func (*CustomOneof) Descriptor() ([]byte, []int) {
	return fileDescriptor_one_0d3990743d3d95b6, []int{3}
}
...
func init() { proto.RegisterFile("combos/unmarshaler/one.proto", fileDescriptor_one_0d3990743d3d95b6) }

var fileDescriptor_one_0d3990743d3d95b6 = []byte{
