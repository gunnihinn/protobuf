...
func (*Subby) Descriptor() ([]byte, []int) {
	return fileDescriptor_one_91eca20222026a87, []int{0}
}
...
func (*SampleOneOf) Descriptor() ([]byte, []int) {
	return fileDescriptor_one_91eca20222026a87, []int{1}
}
...
func init() { proto.RegisterFile("combos/marshaler/one.proto", fileDescriptor_one_91eca20222026a87) }

var fileDescriptor_one_91eca20222026a87 = []byte{
