...
func (*Subby) Descriptor() ([]byte, []int) {
	return fileDescriptor_one_f1816752ff35fa7f, []int{0}
}
...
func (*SampleOneOf) Descriptor() ([]byte, []int) {
	return fileDescriptor_one_f1816752ff35fa7f, []int{1}
}
...
func init() { proto.RegisterFile("combos/unmarshaler/one.proto", fileDescriptor_one_f1816752ff35fa7f) }

var fileDescriptor_one_f1816752ff35fa7f = []byte{
