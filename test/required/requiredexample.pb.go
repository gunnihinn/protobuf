...
func (*RequiredExample) Descriptor() ([]byte, []int) {
	return fileDescriptor_requiredexample_0174bec73e1160ab, []int{0}
}
...
func (*NidOptNative) Descriptor() ([]byte, []int) {
	return fileDescriptor_requiredexample_0174bec73e1160ab, []int{1}
}
...
func (*NinOptNative) Descriptor() ([]byte, []int) {
	return fileDescriptor_requiredexample_0174bec73e1160ab, []int{2}
}
...
func (*NestedNinOptNative) Descriptor() ([]byte, []int) {
	return fileDescriptor_requiredexample_0174bec73e1160ab, []int{3}
}
...
func init() {
	proto.RegisterFile("requiredexample.proto", fileDescriptor_requiredexample_0174bec73e1160ab)
}

var fileDescriptor_requiredexample_0174bec73e1160ab = []byte{
