...
func (*Dropped) Descriptor() ([]byte, []int) {
	return fileDescriptor_typedeclall_2bbdaae7f1e71a28, []int{0}
}
...
func (*DroppedWithoutGetters) Descriptor() ([]byte, []int) {
	return fileDescriptor_typedeclall_2bbdaae7f1e71a28, []int{1}
}
...
func (*Kept) Descriptor() ([]byte, []int) {
	return fileDescriptor_typedeclall_2bbdaae7f1e71a28, []int{2}
}
...
func init() { proto.RegisterFile("typedeclall.proto", fileDescriptor_typedeclall_2bbdaae7f1e71a28) }

var fileDescriptor_typedeclall_2bbdaae7f1e71a28 = []byte{
