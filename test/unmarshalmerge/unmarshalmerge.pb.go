...
func (*Big) Descriptor() ([]byte, []int) {
	return fileDescriptor_unmarshalmerge_f8964de956df05ea, []int{0}
}
...
func (*BigUnsafe) Descriptor() ([]byte, []int) {
	return fileDescriptor_unmarshalmerge_f8964de956df05ea, []int{1}
}
...
func (*Sub) Descriptor() ([]byte, []int) {
	return fileDescriptor_unmarshalmerge_f8964de956df05ea, []int{2}
}
...
func (*IntMerge) Descriptor() ([]byte, []int) {
	return fileDescriptor_unmarshalmerge_f8964de956df05ea, []int{3}
}
...
func init() {
	proto.RegisterFile("unmarshalmerge.proto", fileDescriptor_unmarshalmerge_f8964de956df05ea)
}

var fileDescriptor_unmarshalmerge_f8964de956df05ea = []byte{
