...
func (*NativeWithSizeCache) Descriptor() ([]byte, []int) {
	return fileDescriptor_xxxfields_f9260875a01589b8, []int{0}
}
...
func (*StructWithSizeCache) Descriptor() ([]byte, []int) {
	return fileDescriptor_xxxfields_f9260875a01589b8, []int{1}
}
...
func (*NativeWithoutSizeCache) Descriptor() ([]byte, []int) {
	return fileDescriptor_xxxfields_f9260875a01589b8, []int{2}
}
...
func (*StructWithoutSizeCache) Descriptor() ([]byte, []int) {
	return fileDescriptor_xxxfields_f9260875a01589b8, []int{3}
}
...
func init() { proto.RegisterFile("xxxfields.proto", fileDescriptor_xxxfields_f9260875a01589b8) }

var fileDescriptor_xxxfields_f9260875a01589b8 = []byte{
